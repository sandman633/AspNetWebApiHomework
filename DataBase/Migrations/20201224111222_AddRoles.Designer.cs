...
namespace DataBase.Migrations
{
    ...
    [Migration("20201224111222_AddRoles")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataBase.Domain.UserRoleModels.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DataBase.Domain.UserRoleModels.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DataBase.Domain.UserRoleModels.UserRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DataBase.Domain.UserRoleModels.UserRoles", b =>
                {
                    b.HasOne("DataBase.Domain.UserRoleModels.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId");

                    b.HasOne("DataBase.Domain.UserRoleModels.User", "User")
                        .WithMany()
